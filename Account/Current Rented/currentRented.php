...
$sql = "SELECT Car.*,pick_up_date FROM Car JOIN Current_Renting ON Car.plate_number = Current_Renting.plate_number WHERE Current_Renting.customer_id = '$customer_id'";
            ...
            <?php foreach ($cars as $car): ?>
                <div class="car-card">
                    ...
                    <p><strong>Color:</strong> <span
                            style="background-color: <?php echo $car['color']; ?>; display: inline-block; width: 20px; height: 20px;"></span>
                        <span>
                            <?php echo $car['color']; ?>
                        </span></p>
                    <p><strong>Transmission:</strong> <span>
                            <?php echo $car['is_automatic'] ? 'Automatic' : 'Manual'; ?>
                        </span></p>
                    ...
                    <?php if ($car['pick_up_date'] !== null): ?>
                        <p><strong>Pickup Status:</strong> <span>Picked Up</span></p>
                    <?php else: ?>
                        <p><strong>Pickup Status:</strong> <span>Not Picked Up</span></p>
                    <?php endif; ?>
                </div>
            <?php endforeach; ?>
        </div>
